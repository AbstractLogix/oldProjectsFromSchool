...
public class CarriersId  implements java.io.Serializable {
    ...
    public CarriersId(int id, int carrierTypeId, int stateId, String rowguid) {
        this.id = id;
        this.carrierTypeId = carrierTypeId;
        this.stateId = stateId;
        this.rowguid = rowguid;
    }
    public CarriersId(int id, int carrierTypeId, String name, String phone, String fax, String email, String accountNumber, String firstName, String lastName, int stateId, String address, Integer locationId, String rowguid) {
       this.id = id;
       this.carrierTypeId = carrierTypeId;
       this.name = name;
       this.phone = phone;
    ...
    @Column(name="carrierTypeId", nullable=false)
    ...
    @Column(name="accountNumber", length=70)
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof CarriersId) ) return false;
		 CarriersId castOther = ( CarriersId ) other; 
         
		 return (this.getId()==castOther.getId())
 && (this.getCarrierTypeId()==castOther.getCarrierTypeId())
 ...
 && (this.getStateId()==castOther.getStateId())
 ...
 && ( (this.getRowguid()==castOther.getRowguid()) || ( this.getRowguid()!=null && castOther.getRowguid()!=null && this.getRowguid().equals(castOther.getRowguid()) ) );
   ...
   public int hashCode() {
         ...
         result = 37 * result + this.getCarrierTypeId();
         ...
         result = 37 * result + this.getStateId();
